...
3. [图书][C 和指针](http://product.dangdang.com/20165942.html)
...
8. [图书][MySQL数据库（高洛峰）](http://study.163.com/course/introduction/247003.htm#/courseDetail)
9. [视频][尚学堂马士兵Oracle视频教程](http://study.163.com/course/introduction/344012.htm#/courseDetail)

   * Codd 12 Rules

10. CAP理论: 又称CAP定理，指的是在一个分布式系统中， Consistency（一致性）、 Availability（可用性）、Partition tolerance（分区容错性），三者不可得兼。
...
16. [GitHub][Modern Java - A Guide to Java 8(现代Java - Java指南8)](https://github.com/winterbe/java8-tutorial)
17. 面向对象软件设计
...
1. Servlet
    ...
    2. [图书]Java Servlet & JSP Cookbook
    3. [文章][Servlet 工作原理解析](http://www.ibm.com/developerworks/cn/java/j-lo-servlet)
    4. [视频][Servlet Java  Web 编程（郭宏志）](http://study.163.com/course/introduction/648001.htms)
...
5. [Guava](https://github.com/google/guava)  Google core libraries for Java.(适用于Java的Google核心库。)
...
2. [MemCache](http://memcached.org) A distributed memory object caching system.(分布式内存对象缓存系统。)
3. [EHCache](http://www.ehcache.org/)
4. [Varnish](http://varnish-cache.org) Varnish HTTP Cache.
5. [Squid](http://www.squid-cache.org) Squid is a caching proxy for the Web supporting HTTP, HTTPS, FTP, and more.(Squid是支持HTTP，HTTPS，FTP等的Web的缓存代理。)
...
2. [Dubbo](https://github.com/xianglesong/learning-javas/blob/master/framework/Dubbo.md)
...
6.  [Logstash](https://github.com/elastic/logstash) Logstash - transport and process your logs, events, or other data.(Logstash - 传输和处理您的日志，事件或其他数据。)
7.  [Kibana](https://github.com/elastic/kibana) Kibana analytics and search dashboard for Elasticsearch.(Elasticsearch的Kibana分析和搜索仪表板。)
8.  [JUnit](https://junit.org/junit4) A programmer-oriented testing framework for Java.(面向程序员的Java测试框架。)
9.  [EasyMock](http://easymock.org) EasyMock, makes mocking easier since 2001.(自2001年以来，EasyMock使得模拟变得更容易。)
10. [JFreeChart](http://www.jfree.org/jfreechart) JFreeChart is a free 100% Java chart library that makes it easy for developers to display professional quality charts in their applications.(JFreeChart是一个免费的100％Java图表库，使开发人员可以轻松地在其应用程序中显示专业质量的图表。)
...
2. [Kafka](http://kafka.apache.org) A distributed streaming platform.
...
3. [ZeroMQ](http://zeromq.org) Distributed Messaging.
...
3. [Docker](https://www.docker.com) Build, Manage and Secure Your Apps Anywhere. Your Way.(随处构建，管理和保护您的应用程序。 你的方式。)
...
7. [Mesos](http://mesos.apache.org) Apache Mesos abstracts CPU, memory, storage, and other compute resources away from machines (physical or virtual), enabling fault-tolerant and elastic distributed systems to easily be built and run effectively.(Apache Mesos将CPU，内存，存储和其他计算资源从机器（物理或虚拟）中抽象出来，使容错和弹性分布式系统能够轻松构建并有效运行。)
...
3. [图书][HTTP权威指南](http://product.dangdang.com/22840157.html)
4. [图书][HTML & CSS 设计与构建网站](http://product.dangdang.com/23780195.html)
5. [图书][JavaScript & jQuery交互式Web前端开发](http://product.dangdang.com/23731286.html)
6. [图书][HTML5权威指南](http://product.dangdang.com/23386583.html)
7. [文章][https://developer.mozilla.org/zh-CN/docs/Web](https://developer.mozilla.org/zh-CN/docs/Web)
8. [视频][8小时学会HTML网页开发](http://study.163.com/course/courseMain.htm?courseId=432008)
9. [视频][翁恺 HTML5入门](http://study.163.com/course/introduction/171001.htm#/courseDetail)
10. [视频][麦子学院 HTML5+CSS3快速入门](http://study.163.com/course/courseMain.htm?courseId=999036)
11. [视频][妙味 HTML5前端开发实战1](http://study.163.com/course/courseMain.htm?courseId=717031#/courseDetail)
12. [视频][妙味 HTML5前端开发实战2](http://study.163.com/course/introduction/717017.htm#/courseDetail)
13. [图书][CSS权威指南](http://product.dangdang.com/20050535.html) 必读
14. [图书][CSS揭秘](http://product.dangdang.com/23953090.html) 书的序是《CSS权威指南》的作者写的。
15. [图书][CSS禅意花园](http://product.dangdang.com/22806937.html) 是通过一个html，不同的css显示不同效果的实例，非常值得学习。
16. [文章]CSS的核心之一：盒子模型
17. [文章][CSS的核心之一：position](http://www.barelyfitz.com/screencast/html-training/css/positioning)
18. [源码][CSS ZEN GARDEN](http://www.csszengarden.com)
19. [框架][Bootstrap](https://getbootstrap.com/) Bootstrap is an open source toolkit for developing with HTML, CSS, and JS.(Bootstrap是一个用于使用HTML，CSS和JS进行开发的开源工具包。)
20. [框架][EasyUI](https://www.jeasyui.com/) EasyUI for jQuery provides easy to use components for web developers, which is built on the popular jQuery core and HTML5. These make your applications suitable for today's web.(EasyUI for jQuery为Web开发人员提供了易于使用的组件，它基于流行的jQuery核心和HTML5构建。 这些使您的应用程序适合当今的Web。)
21. [GitHub][Material Design icons by Google(Google的Material Design图标)](https://github.com/google/material-design-icons)
...
1. 版本管理
   ...
   2. [图书][Git权威指南](http://product.dangdang.com/21108669.html)
   3. [图书][Git版本控制管理](http://product.dangdang.com/23657840.html)
   4. [图书][精通Git](http://product.dangdang.com/25166975.html) GitHub联合创始人倾心之作，没有版本控制概念的读者也可轻松入门，涵盖Git常见工作场景，有效帮助程序员提升软技能。
   5. [GitHub][A collection of .gitignore templates](https://github.com/github/gitignore)
   6. [Gitlab](https://about.gitlab.com/) GitLab is the leading integrated product for modern software development. Connecting issue management, version control, code review, CI, CD, and monitoring.(GitLab是现代软件开发的领先集成产品。 连接问题管理，版本控制，代码审查，CI，CD和监控。)
   7. [Bitbucket](https://bitbucket.org/product) 类似github的功能，不过是可以闭源。(Bitbucket is more than just Git code management. Bitbucket gives teams one place to plan projects, collaborate on code, test and deploy.)
   8. [Mercurial](https://www.mercurial-scm.org) 源码控制管理工具。(Mercurial is a free, distributed source control management tool.)
...
4. [软考](http://www.ruankao.org.cn/)
    ...
    2. 软件设计师  个人觉得大三学生可以开始考这个，工作的就更容易了。
    3. 信息系统项目管理师  这个偏管理的，主要是论文会卡人，容易的考个中级的系统集成项目管理工程师就可以，这个不考论文。
...
6. [JumpServer](http://www.jumpserver.org/) 是全球首款完全开源的堡垒机,使用GNU GPL v2.0开源协议,是符合 4A 的专业运维安全审计系统。
7. [图书][海量运维、运营规划之道](http://product.dangdang.com/23380755.html)
8. [图书][网站运维技术与实践]
9. Zabbix
    1. [图书][Zabbix监控系统]
...
3. [Chrome](https://www.google.cn/chrome) 浏览器。
4. [搜狗输入法](https://pinyin.sogou.com/mac) 输入法。
5. [Foxmail](https://www.foxmail.com) 邮箱管理。
6. [EverNote](https://evernote.com/intl/zh-cn) 随时随地获取、整理、分享笔记，让灵感时刻与你同行。
7. [XMind](https://www.xmind.net) 思维导图工具。
8. [FileZilla](https://filezilla-project.org) The free FTP solution.
9. [Jet Brains](http://www.jetbrains.com) JetBrains, creator of the leading Java IDE - IntelliJ IDEA - is a cutting-edge software vendor specializing in the creation of intelligent development tools.
10. [Wireshark](https://www.wireshark.org) 网络封包分析软件。
11. [CleanMyMac](https://cleanmymac.com) Your Mac. As good as new. Mac清理管理工具。
12. [RescueTime](https://www.rescuetime.com) A personal analytics service that shows you how you spend your time and provides tools to help you be more productive. 时间花费跟踪工具。
13. [StarUML](http://staruml.io) A sophisticated software modeler for agile and concise modeling.
14. [Skype](https://web.skype.com) 是超清晰网络电话工具，电脑间通话永远免费，打国内国际固定/移动电话只需市话费。
15. [Sequel Pro](http://www.sequelpro.com) Sequel Pro is a fast, easy-to-use Mac database management application for working with MySQL databases.
16. [Parall Client](https://www.parallels.com/cn/products/ras/features/parallels-client) Parallels Client is an easy-to-install client software that provides access to your Parallels RAS installations.
17. [Dash](https://kapeli.com/dash)  快速访问API。(Dash gives your Mac instant offline access to 200+ API documentation sets.)
18. [Redis Desktop Manager](https://redisdesktop.com/)  访问Redis的工具。(Redis Desktop Manager (aka RDM) — is a fast open source Redis database management application for Windows, Linux and MacOS.)
19. [图书][Redis实战](http://product.dangdang.com/23800641.html)
20. [Robo 3T](https://robomongo.org/)  访问MongoDB的工具。(Robo 3T (formerly Robomongo) is the free lightweight GUI for MongoDB enthusiasts.)
21. [MongoHub](https://github.com/jeromelebel/MongoHub-Mac)  访问MongoDB的工具。(Mac Native Mongodb Client.)
22. [SourceTree](https://www.sourcetreeapp.com)  版本控制管理工具。(The friendly GUI for Mercurial and Git on your Mac.)
23. [SnailSVN](https://langui.net/snailsvn) 访问svn工具。
24. [MacDown](http://macdown.uranusjr.com) MarkDown编写工具。
25. [Sublime Text](http://www.sublimetext.com)  免费的文本编辑工具。(A sophisticated text editor for code, markup and prose.)
26. [Wunderlist: To-Do List & Tasks](https://www.wunderlist.com/zh) TODO工具。奇妙清单是完成工作的最简单方法。无论你是在安排度假、与伙伴分享购物清单，或是管理多个工作项目，奇妙清单会帮助你完成所有个人和职业待办事项。
27. [Luyten](https://github.com/deathmarine/Luyten) An Open Source Java Decompiler Gui for Procyon.
28. [GNS3](https://www.gns3.com) The software that empowers network professionals.
29. [Office](https://products.office.com/zh-cn/mac/microsoft-office-for-mac) 确是 Office，专为 Mac 打造。
30. [LaTeX](https://www.latex-project.org) LaTeX is a high-quality typesetting system.
31. [Postman](https://www.getpostman.com) Postman is the only complete API development environment, for API developers.
...
5. 其他图书
     1. [图书]编码的奥秘
     2. [图书][松本行弘的程序世界](http://product.dangdang.com/22471151.html)
     3. [图书][编程珠玑](http://product.dangdang.com/23640352.html)
...
2. [InfoQ](http://www.infoq.com) 架构师网站。
3. [ChinaUnix](http://www.chinaunix.net) 中国最大的Linux/Unix技术社区网站。
4. [博客园](https://www.cnblogs.com) 博客园是一个面向开发者的知识分享社区。
5. [http://www.iteye.com](http://www.iteye.com)
...
2. [Stack Overflow.com](https://stackoverflow.com) 问答网。
3. [在线JSON校验格式化工具bejson](http://www.bejson.com)
4. [GitHub][成为一名专业程序员](https://github.com/stanzhai/be-a-professional-programmer) 成为专业程序员路上用到的各种优秀资料、神器及框架。
5. [WordPress](https://cn.wordpress.org) WordPress是使用PHP语言开发的博客平台，用户可以在支持PHP和MySQL数据库的服务器上架设属于自己的网站。也可以把 WordPress当作一个内容管理系统（CMS）来使用。
